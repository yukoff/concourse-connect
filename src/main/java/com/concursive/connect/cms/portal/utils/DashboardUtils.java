...
/**
 * Class to work with dashboard pages
 *
...
public class DashboardUtils {
  ...
  private static Log LOG = LogFactory.getLog(DashboardUtils.class);

  public static DashboardPage loadDashboardPage(String type, String name) throws Exception {
    return loadDashboardPage(type, name, null);
  }

  public static DashboardPage loadDashboardPage(String type, String name, String fileName) throws Exception {
    if (System.getProperty("DEBUG") == null) {
      ...
      DashboardTemplateList templates = new DashboardTemplateList(type, fileName);
      DashboardTemplate template = templates.getTemplateByName(name);
      if (template == null) {
        return null;
      }
