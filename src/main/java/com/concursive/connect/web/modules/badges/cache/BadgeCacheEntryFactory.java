 ...
 */
package com.concursive.connect.web.modules.badges.cache;
 ...
 */
public class BadgeCacheEntryFactory implements CacheEntryFactory {

  private CacheContext context = null;

  public BadgeCacheEntryFactory(CacheContext context) {
  ...
  public Object createEntry(Object key) throws Exception {
    ...
    try {
      ...
      Badge badge = new Badge(db, Integer.parseInt(key.toString()));
      badge.buildLogo(db);
      return badge;
    } catch (Exception e) {
