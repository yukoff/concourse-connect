...
/**
 * Class for calculating user contributions based on the number of blogs added
 *
...
public class ContributionCalculationForBlogsPublished extends ContributionCalculation {
