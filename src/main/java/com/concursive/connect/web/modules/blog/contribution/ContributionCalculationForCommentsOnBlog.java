...
package com.concursive.connect.web.modules.blog.contribution;
...
/**
 * Class for calculating user contributions based on the number blogs that have received a comment
 *
...
public class ContributionCalculationForCommentsOnBlog extends ContributionCalculation {
