 ...
 */
public class BlogDeleteCommentViewer implements IPortletViewer {
  public String doView(RenderRequest request, RenderResponse response)
    ...
    if (!user.getAccessAdmin()) {
      throw new PortletException("Unauthorized to delete comments in projects");
    }
    ...
    BlogPostComment thisBlogPostComment = new BlogPostComment(db, recordId);
    thisBlogPostComment.delete(db);
