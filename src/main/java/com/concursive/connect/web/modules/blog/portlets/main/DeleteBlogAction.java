 ...
 */
public class DeleteBlogAction implements IPortletAction {
  ...
  public GenericBean processAction(ActionRequest request, ActionResponse response) throws Exception {
    ...
    if (!ProjectUtils.hasAccess(project.getId(), user, "project-news-delete")) {
    ...
    // @todo make this unique projects-news go away
    thisArticle.delete(db, getFileLibraryPath(request, "projects-news"));

    // Remove from index
    indexDeleteItem(request, thisArticle);

    // Trigger the workflow
    processDeleteHook(request, thisArticle);
