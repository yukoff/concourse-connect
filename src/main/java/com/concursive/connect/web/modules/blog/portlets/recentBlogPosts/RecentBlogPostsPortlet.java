 ...
 */
public class RecentBlogPostsPortlet extends AbstractPortletModule {

  private static Log LOG = LogFactory.getLog(RecentBlogPostsPortlet.class);

  // Viewers
  public static final String LIST_VIEW = "list";
  public static final String DEFAULT_VIEW = LIST_VIEW;

  public RecentBlogPostsPortlet() {
    defaultCommand = DEFAULT_VIEW;
  }

  protected void doPopulateActionsAndViewers() {
    // Viewers
    viewers.put(LIST_VIEW, new RecentBlogPostsViewer());
  }
}
