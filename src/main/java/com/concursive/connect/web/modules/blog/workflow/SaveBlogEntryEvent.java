...
/**
 * Records a project blog entry event
 *
 * @author Ananth
 * @created Feb 19, 2009
 */
public class SaveBlogEntryEvent extends ObjectHookComponent implements ComponentInterface {
  ...
  public boolean execute(ComponentContext context) {
    ...
    try {
      ...
      // If the news article is published and active, or if it was previously
      // not published and is now published
      if ((previousArticle == null && thisArticle.getStatus() == BlogPost.PUBLISHED) ||
          (previousArticle != null && previousArticle.getStatus() != BlogPost.PUBLISHED && thisArticle.getStatus() == BlogPost.PUBLISHED)) {
