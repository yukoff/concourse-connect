...
/**
 * Increments the viewing counter for a news article
 *
 * @author matt rajkowski
 * @created April 25, 2008
 */
public class SaveNewsArticleViewing extends ObjectHookComponent implements ComponentInterface {

  public String getDescription() {
    return "Increments the viewing counter for a news article";
  }
