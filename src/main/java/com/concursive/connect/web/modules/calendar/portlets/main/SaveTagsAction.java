...
public class SaveTagsAction implements IPortletAction {
  ...
  public GenericBean processAction(ActionRequest request, ActionResponse response) throws Exception {
    ...
    userTagLogList.setLinkModuleId(Constants.PROJECTS_CALENDAR_EVENT_FILES);
    ...
    moduleTagList.setTableName(Meeting.TABLE);
    moduleTagList.setUniqueField(Meeting.PRIMARY_KEY);
