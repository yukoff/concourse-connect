...
public class MeetingEventList {
  ...
  /**
   * Gets meetingList attribute of MeetingEventList Class
   *
   * @return MeetingList
   */
  ...
  /**
   * Sets meetingList attribute of MeetingEventList Class
   *
   * @param meetingList
   */
   ...
   *
   * @param thisMeeting The feature to be added to the Event attribute
   */
  public void addEvent(Meeting thisMeeting) {
    if (thisMeeting != null) {
      meetingList.add(thisMeeting);
    }
  }
}
