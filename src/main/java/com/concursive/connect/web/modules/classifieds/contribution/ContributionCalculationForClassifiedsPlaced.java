...
/**
 * Class for calculating user contributions based on the number of classifieds placed
 *
...
public class ContributionCalculationForClassifiedsPlaced extends ContributionCalculation {
