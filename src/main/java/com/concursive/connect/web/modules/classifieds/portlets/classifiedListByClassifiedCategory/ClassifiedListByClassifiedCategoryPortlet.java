 ...
 */
public class ClassifiedListByClassifiedCategoryPortlet extends AbstractPortletModule {

  // Logger
  private static Log LOG = LogFactory.getLog(ClassifiedListByClassifiedCategoryPortlet.class);

  // Viewers
  public static final String DEFAULT_VIEW = "list";
  public static final String LIST_VIEW = "list";

  public ClassifiedListByClassifiedCategoryPortlet() {
  ...
  protected void doPopulateActionsAndViewers() {
    // Viewers
    viewers.put(LIST_VIEW, new ClassifiedListByClassifiedCategoryViewer());
  }
}