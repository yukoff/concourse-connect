 ...
 */
package com.concursive.connect.web.modules.classifieds.portlets.classifiedResultsSorter;
 ...
 */
public class ClassifiedResultsSorter implements IPortletViewer {

  // Pages
  private static final String VIEW_PAGE = "/portlets/classified_sorter_portlet/classified_sorter_portlet-view.jsp";

  // Object Results
  private static final String CATEGORY_NAME_ATTRIBUTE = "categoryName";
  private static final String CLASSIFIED_CATEGORY_NAME_ATTRIBUTE = "classifiedCategoryName";
  ...
  public String doView(RenderRequest request, RenderResponse response)
    ...
    try {
      ...
      request.setAttribute(CLASSIFIED_CATEGORY_NAME_ATTRIBUTE, ClassifiedCategory.getNormalizedCategoryName(classifiedCategoryName));
      request.setAttribute(Constants.REQUEST_GENERATED_TITLE, classifiedCategoryName);
      ...
      // page/classifieds/{project category}/{classified category}?sort=alpha
