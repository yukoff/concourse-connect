 ...
 */
public class ClassifiedSearchViewer implements IPortletViewer {

  // Pages
  private static final String VIEW_PAGE = "/portlets/classified_search/classified_search-view.jsp";
  ...
  public String doView(RenderRequest request, RenderResponse response)
    ...
    try {
      ...
      String pageURL = request.getPreferences().getValue(PREF_PAGE_URL, "/page/classifieds/all");
