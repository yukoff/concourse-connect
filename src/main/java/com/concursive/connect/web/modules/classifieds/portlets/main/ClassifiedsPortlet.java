...
/**
 * Project Classifieds mvc portlet
 *
 * @author matt rajkowski
 * @created November 7, 2008
 */
public class ClassifiedsPortlet extends AbstractPortletModule {
  ...
  protected void doPopulateActionsAndViewers() {
    // Viewers
    viewers.put(LIST_VIEW, new ClassifiedsListViewer());
    viewers.put(SUMMARY_VIEW, new ClassifiedsSummaryViewer());
