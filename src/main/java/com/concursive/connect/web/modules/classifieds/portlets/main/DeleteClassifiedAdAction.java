 ...
 */
public class DeleteClassifiedAdAction implements IPortletAction {
  ...
  public GenericBean processAction(ActionRequest request, ActionResponse response) throws Exception {
    ...
    // Delete the record
    classified.delete(db, getFileLibraryPath(request, "projects"));

    // Remove from index
    indexDeleteItem(request, classified);

    // Trigger the workflow
    processDeleteHook(request, classified);
