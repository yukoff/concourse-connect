...
/**
 * Expire a classified ad
 *
 * @author Kailash Bhoopalam
 * @created January 8, 2009
 */
public class ExpireClassifiedAdAction implements IPortletAction {
  ...
  public GenericBean processAction(ActionRequest request, ActionResponse response) throws Exception {
    ...
    if (!ProjectUtils.hasAccess(project.getId(), user, "project-classifieds-add")) {
      throw new PortletException("Unauthorized to delete in this expire this classified ad");
    }
    ...
    if (classified.getPublishDate() != null &&
      ...
      throw new PortletException("Unauthorized to expire this classified");
    }
