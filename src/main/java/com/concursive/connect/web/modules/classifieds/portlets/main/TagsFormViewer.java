...
public class TagsFormViewer implements IPortletViewer {
  ...
  public String doView(RenderRequest request, RenderResponse response) throws Exception {
    ...
    popularTagList.setTableName(Classified.TABLE);
    popularTagList.setUniqueField(Classified.PRIMARY_KEY);
    ...
    tagLogList.setTableName(Classified.TABLE);
    tagLogList.setUniqueField(Classified.PRIMARY_KEY);
