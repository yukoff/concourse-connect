...
/**
 * Records a project classified ad entry event..
 *
 * @author Ananth
 * @created Feb 20, 2009
 */
public class SaveClassifiedAdEntryEvent extends ObjectHookComponent implements ComponentInterface {
  ...
  public String getDescription() {
    return "Records a project classified ad entry event..";
  }
