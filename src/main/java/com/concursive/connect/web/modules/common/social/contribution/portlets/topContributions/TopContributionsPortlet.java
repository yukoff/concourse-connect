 ...
 */
public class TopContributionsPortlet extends AbstractPortletModule {

  private static Log LOG = LogFactory.getLog(TopContributionsPortlet.class);

  // Viewers
  public static final String LIST_VIEW = "list";
  public static final String DEFAULT_VIEW = LIST_VIEW;

  public TopContributionsPortlet() {
    defaultCommand = DEFAULT_VIEW;
  }

  protected void doPopulateActionsAndViewers() {
    // Viewers
    viewers.put(LIST_VIEW, new TopContributionsViewer());
  }
}
