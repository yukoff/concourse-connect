...
/**
 * Returns information on US zip codes
 *
...
public class LocationUtils {
  ...
  public static LocationBean findLocationByZipCode(String zipCode) {
    // validate length
    String zipCodeToFind;
    if (zipCode.length() == 5) {
      zipCodeToFind = zipCode;
    } else if (zipCode.length() == 10) {
      zipCodeToFind = zipCode.substring(0, 5);
    } else {
      return null;
    }
