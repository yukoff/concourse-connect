...
/**
 * The properties for tagging an object
 *
...
public class Tag extends GenericBean {
  ...
  public void setTagCount(String tagCount) {
    this.tagCount = Integer.parseInt(tagCount);
  }
  ...
  public String getNormalizedTag() {
    return StringUtils.replace(tag.toLowerCase(), " ", "-");
  }

  public static String getNormalizedTag(String tagName) {
    if (StringUtils.hasText(tagName)) {
      return StringUtils.replace(tagName.toLowerCase(), " ", "-");
    }
    return null;
  }
  ...
  public void buildRecord(ResultSet rs) throws SQLException {
    ...
    tagCount = DatabaseUtils.getInt(rs, "tag_count", 0);
