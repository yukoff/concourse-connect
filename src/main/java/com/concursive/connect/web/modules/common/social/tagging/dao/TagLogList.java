...
/**
 * A collection of tag log items
 *
 * @author Kailash Bhoopalam
 * @created July 17, 2008
 */
public class TagLogList extends ArrayList<TagLog> {
  ...
  public void buildList(Connection db) throws SQLException {
    ...
    sqlSelect.append(
        uniqueField + ", user_id, tag, tag_date " +
            " FROM " + tableName + "_tag_log" +
            " WHERE user_id > -1 ");
    ...
    while (rs.next()) {
      ...
      ++count;
      TagLog thisTagLog = new TagLog();
      thisTagLog.setUniqueField(uniqueField);
      thisTagLog.buildRecord(rs);
      this.add(thisTagLog);
    }
    rs.close();
    pst.close();
  ...
  public String getTagsAsString() {
    ...
    Iterator<TagLog> itr = this.iterator();
    while (itr.hasNext()) {
      tagAsStringBuffer.append(itr.next().getTag());
      if (itr.hasNext()) {
        tagAsStringBuffer.append(", ");
      }
    }
