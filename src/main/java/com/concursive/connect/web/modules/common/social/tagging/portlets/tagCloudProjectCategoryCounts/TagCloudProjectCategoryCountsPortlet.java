 ...
 */
public class TagCloudProjectCategoryCountsPortlet extends AbstractPortletModule {

  // Logger
  private static Log LOG = LogFactory.getLog(TagCloudProjectCategoryCountsPortlet.class);

  // Viewers
  public static final String DEFAULT_VIEW = "list";
  public static final String LIST_VIEW = "list";

  public TagCloudProjectCategoryCountsPortlet() {
    defaultCommand = DEFAULT_VIEW;
  }

  protected void doPopulateActionsAndViewers() {
    // Viewers
    viewers.put(LIST_VIEW, new TagCloudProjectCategoryCountsViewer());
  }
}
