...
/**
 * Class for calculating user contributions based on the number of topics answered
 *
...
public class ContributionCalculationForTopicsAnswered extends ContributionCalculation {
