 ...
 */
public class DiscussionForumTemplateList extends ArrayList<DiscussionForumTemplate> {

  private int forumTemplateId = -1;
  ...
  public DiscussionForumTemplateList() {
  }
  ...
  public void setForumTemplateId(String tmp) {
    this.forumTemplateId = Integer.parseInt(tmp);
  }
  ...
  public void buildList(Connection db) throws SQLException {
    ...
    while (rs.next()) {
      ...
      ++count;
      DiscussionForumTemplate thisRecord = new DiscussionForumTemplate(rs);
      this.add(thisRecord);
    }
    rs.close();
    pst.close();
