...
public class TopicIndexer implements Indexer {
  ...
  private static Log LOG = LogFactory.getLog(TopicIndexer.class);
  ...
  public Term getSearchTerm(Object item) {
    Topic topic = (Topic) item;
    return new Term("issueKeyId", String.valueOf(topic.getId()));
  }
  ...
  public Term getDeleteTerm(Object item) {
    Topic topic = (Topic) item;
    return new Term("issueId", String.valueOf(topic.getId()));
  }
}
