...
public class SaveTagsTopicAction implements IPortletAction {
  ...
  public GenericBean processAction(ActionRequest request, ActionResponse response) throws Exception {
    ...
    userTagLogList.setLinkModuleId(Constants.DISCUSSION_FILES_TOPIC);
    ...
    moduleTagList.setTableName(Topic.TABLE);
    moduleTagList.setUniqueField(Topic.PRIMARY_KEY);
