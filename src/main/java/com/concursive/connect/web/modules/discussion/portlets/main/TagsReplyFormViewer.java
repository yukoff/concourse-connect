 ...
 * @created Oct 16, 2009
 */
public class TagsReplyFormViewer implements IPortletViewer {
  // pages
  ...
  public String doView(RenderRequest request, RenderResponse response) throws Exception {
    ...
    popularTagList.setTableName(Reply.TABLE);
    popularTagList.setUniqueField(Reply.PRIMARY_KEY);
    ...
    tagLogList.setTableName(Reply.TABLE);
    tagLogList.setUniqueField(Reply.PRIMARY_KEY);
    ...
    request.setAttribute("actionSuffix", "Reply");
