 ...
 * @created Oct 8, 2009
 */
public class TagsTopicFormViewer implements IPortletViewer {
  // pages
  ...
  public String doView(RenderRequest request, RenderResponse response) throws Exception {
    ...
    if (!ModuleUtils.MODULENAME_DISCUSSION_TOPIC.equals(moduleName)) {
    ...
    try {
      Topic topic = new Topic(db, linkItemId);
    } catch (Exception e) {
    ...
    popularTagList.setTableName(Topic.TABLE);
    popularTagList.setUniqueField(Topic.PRIMARY_KEY);
    ...
    tagLogList.setTableName(Topic.TABLE);
    tagLogList.setUniqueField(Topic.PRIMARY_KEY);
    ...
    request.setAttribute("actionSuffix", "Topic");
