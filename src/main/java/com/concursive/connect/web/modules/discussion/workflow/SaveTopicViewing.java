...
/**
 * Increments the viewing counter for a topic
 *
 * @author matt rajkowski
 * @created April 25, 2008
 */
public class SaveTopicViewing extends ObjectHookComponent implements ComponentInterface {

  public String getDescription() {
    return "Increments the viewing counter for an issue";
  }
