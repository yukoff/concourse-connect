...
public class TagsFormViewer implements IPortletViewer {
  ...
  public String doView(RenderRequest request, RenderResponse response) throws Exception {
    ...
    try {
      FileItem thisFile = new FileItem(db, linkItemId);
    } catch (Exception e) {
    ...
    popularTagList.setTableName(FileItem.TABLE);
    popularTagList.setUniqueField(FileItem.PRIMARY_KEY);
    ...
    tagLogList.setTableName(FileItem.TABLE);
    tagLogList.setUniqueField(FileItem.PRIMARY_KEY);
