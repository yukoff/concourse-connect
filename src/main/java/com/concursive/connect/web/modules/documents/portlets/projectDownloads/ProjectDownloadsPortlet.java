 ...
 */
public class ProjectDownloadsPortlet extends AbstractPortletModule {

  private static Log LOG = LogFactory.getLog(ProjectDownloadsPortlet.class);

  // Viewers
  public static final String DEFAULT_VIEW = "list";
  public static final String LIST_VIEW = "list";

  public ProjectDownloadsPortlet() {
    defaultCommand = DEFAULT_VIEW;
  }

  protected void doPopulateActionsAndViewers() {
    // viewers
    viewers.put(LIST_VIEW, new ProjectDownloadsViewer());
  }
}