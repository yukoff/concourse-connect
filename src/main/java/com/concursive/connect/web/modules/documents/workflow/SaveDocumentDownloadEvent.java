...
/**
 * Records a project document download event..
 *
 * @author Ananth
 * @created Feb 20, 2009
 */
public class SaveDocumentDownloadEvent extends ObjectHookComponent implements ComponentInterface {
  public final static String HISTORY_TEXT = "history.text";

  public String getDescription() {
    return "Records a project document download event..";
  }
  ...
  public boolean execute(ComponentContext context) {
    ...
    try {
      ...
      if (thisFile.getLinkModuleId() == Constants.PROJECTS_FILES &&
          thisFile.getDownloads() == (prevFile.getDownloads() + 1)) {
