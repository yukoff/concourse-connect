...
/**
 * Records a project document entry event..
 *
 * @author Ananth
 * @created Feb 20, 2009
 */
public class SaveDocumentEntryEvent extends ObjectHookComponent implements ComponentInterface {
  ...
  public String getDescription() {
    return "Records a project document entry event..";
  }
