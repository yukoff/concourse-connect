 ...
 * @version $Id: v.java,v 1.3 2003/01/14 21:23:13
 *          Exp $
 * @created March 19, 2007
 */
public class QueryTicketHasNewComments extends ObjectHookComponent implements ComponentInterface {
  ...
  public String getDescription() {
    return "Does this ticket have new comments?";
  }
  ...
  public boolean execute(ComponentContext context) {
    ...
    return StringUtils.hasText(thisTicket.getComment());
  }
}
