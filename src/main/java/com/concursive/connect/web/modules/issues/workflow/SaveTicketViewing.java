...
/**
 * Increments the viewing counter for a ticket
 *
 * @author matt rajkowski
 * @created April 25, 2008
 */
public class SaveTicketViewing extends ObjectHookComponent implements ComponentInterface {

  public String getDescription() {
    return "Increments the viewing counter for a ticket";
  }
