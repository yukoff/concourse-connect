...
/**
 * Project Team Members mvc portlet
 *
 * @author matt rajkowski
 * @created November 7, 2008
 */
public class TeamMembersPortlet extends AbstractPortletModule {

  private static Log LOG = LogFactory.getLog(TeamMembersPortlet.class);
...
//  public static final String CLONE_ACTION = "clone";
  ...
  public TeamMembersPortlet() {
    defaultCommand = DEFAULT_VIEW;
  }

  protected void doPopulateActionsAndViewers() {
    // Viewers
    viewers.put(LIST_VIEW, new TeamMemberListViewer());

    // Actions
    actions.put(DELETE_ACTION, new DeleteTeamMemberAction());
  }
}