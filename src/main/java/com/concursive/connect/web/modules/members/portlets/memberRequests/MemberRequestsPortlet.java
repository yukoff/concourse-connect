 ...
 */
public class MemberRequestsPortlet extends AbstractPortletModule {

  private static Log LOG = LogFactory.getLog(MemberRequestsPortlet.class);
  ...
  public MemberRequestsPortlet() {
    defaultCommand = DEFAULT_VIEW;
  }

  protected void doPopulateActionsAndViewers() {
    // Viewers
    viewers.put(LIST_VIEW, new MemberRequestsViewer());
