 ...
 */
public class LoadTeamMembersWithPermission extends ObjectHookComponent implements ComponentInterface {

  public final static String PROJECT_ID = "projectId";
  public final static String PROJECT = "project";
  public final static String USER_IDS = "userIds";
  public final static String PROJECT_PERMISSION = "project.permission";
