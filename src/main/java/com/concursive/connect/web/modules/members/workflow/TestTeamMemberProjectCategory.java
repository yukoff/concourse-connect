...
/**
 * Tests if the team member's project category matches the specified category
 *
 * @author Kailash Bhoopalam
 * @created August 20, 2008
 */
public class TestTeamMemberProjectCategory extends ObjectHookComponent implements ComponentInterface {
  ...
  public boolean execute(ComponentContext context) {
    ...
    Project thisProject = ProjectUtils.loadProject(thisTeamMember.getProjectId());
