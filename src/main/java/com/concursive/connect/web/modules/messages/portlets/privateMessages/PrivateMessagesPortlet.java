...
/**
 * Pending Private Messages mvc portlet
 *
 * @author Kailash Bhoopalam
 * @created December 21, 2008
 */
public class PrivateMessagesPortlet extends AbstractPortletModule {

  // Logger
  private static Log LOG = LogFactory.getLog(PrivateMessagesViewer.class);
  ...
  public PrivateMessagesPortlet() {
    defaultCommand = DEFAULT_VIEW;
  }

  protected void doPopulateActionsAndViewers() {
    // Viewers
    viewers.put(LIST_VIEW, new PrivateMessagesViewer());
    viewers.put(DETAILS_VIEW, new PrivateMessageViewer());
  }
