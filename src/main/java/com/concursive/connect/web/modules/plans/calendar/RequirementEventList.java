 ...
 */
public class RequirementEventList {
  RequirementList openRequirements = new RequirementList();
  int size = 0;

  /**
   * Gets openRequirements attribute of the RequirementEventList Class
   *
  ...
  /**
   * Sets openRequirements attribute of the RequirementEventList Class
   *
   * @param openRequirements
   */
   ...
   *
   * @param thisRequirement The feature to be added to the Event attribute
   */
  public void addEvent(Requirement thisRequirement) {
