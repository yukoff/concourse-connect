...
public class AssignmentIndexer implements Indexer {
  ...
  private static Log LOG = LogFactory.getLog(AssignmentIndexer.class);
  ...
  public Term getSearchTerm(Object item) {
    Assignment assignment = (Assignment) item;
    return new Term("assignmentKeyId", String.valueOf(assignment.getId()));
  }
  ...
  public Term getDeleteTerm(Object item) {
    Assignment assignment = (Assignment) item;
    return new Term("assignmentId", String.valueOf(assignment.getId()));
  }
}
