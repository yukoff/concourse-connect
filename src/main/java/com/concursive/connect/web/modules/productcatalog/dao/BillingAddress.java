 ...
 */
public class BillingAddress extends GenericBean {
  ...
  private boolean useForShipping = false;
  ...
  /**
   * Gets the id attribute of the BillingAddress object
   *
   * @return The id value
   */
  public int getId() {
  ...
  /**
   * Sets the id attribute of the BillingAddress object
   *
  ...
  /**
   * Gets the orderId attribute of the BillingAddress object
   *
  ...
  /**
   * Sets the orderId attribute of the BillingAddress object
   *
  ...
  /**
   * Gets the attempt attribute of the BillingAddress object
   *
  ...
  /**
   * Sets the attempt attribute of the BillingAddress object
   *
  ...
  /**
   * Gets the nameFirst attribute of the BillingAddress object
   *
  ...
  /**
   * Sets the nameFirst attribute of the BillingAddress object
   *
  ...
  /**
   * Gets the nameLast attribute of the BillingAddress object
   *
  ...
  /**
   * Sets the nameLast attribute of the BillingAddress object
   *
  ...
  /**
   * Gets the organization attribute of the BillingAddress object
   *
  ...
  /**
   * Sets the organization attribute of the BillingAddress object
   *
  ...
  /**
   * Gets the addressLine1 attribute of the BillingAddress object
   *
  ...
  /**
   * Sets the addressLine1 attribute of the BillingAddress object
   *
  ...
  /**
   * Gets the addressLine2 attribute of the BillingAddress object
   *
  ...
  /**
   * Sets the addressLine2 attribute of the BillingAddress object
   *
  ...
  /**
   * Gets the addressLine3 attribute of the BillingAddress object
   *
  ...
  /**
   * Sets the addressLine3 attribute of the BillingAddress object
   *
  ...
  /**
   * Gets the city attribute of the BillingAddress object
   *
  ...
  /**
   * Sets the city attribute of the BillingAddress object
   *
  ...
  /**
   * Gets the state attribute of the BillingAddress object
   *
  ...
  /**
   * Sets the state attribute of the BillingAddress object
   *
  ...
  /**
   * Gets the postalCode attribute of the BillingAddress object
   *
  ...
  /**
   * Sets the postalCode attribute of the BillingAddress object
   *
  ...
  /**
   * Gets the country attribute of the BillingAddress object
   *
  ...
  /**
   * Sets the country attribute of the BillingAddress object
   *
  ...
  /**
   * Gets the email attribute of the BillingAddress object
   *
  ...
  /**
   * Sets the email attribute of the BillingAddress object
   *
  ...
  /**
   * Gets the useForShipping attribute of the BillingAddress object
   *
   * @return The useForShipping value
   */
  ...
  /**
   * Sets the useForShipping attribute of the BillingAddress object
   *
   * @param tmp The new useForShipping value
   */
  public void setUseForShipping(boolean tmp) {
    this.useForShipping = tmp;
  }
   ...
   * @param tmp The new useForShipping value
   */
  public void setUseForShipping(String tmp) {
    this.useForShipping = DatabaseUtils.parseBoolean(tmp);
  }
  ...
  /**
   * Gets the valid attribute of the BillingAddress object
   *
  ...
  public boolean insert(Connection db) throws SQLException {
    ...
    pst.setBoolean(++i, useForShipping);
    pst.execute();
    pst.close();
