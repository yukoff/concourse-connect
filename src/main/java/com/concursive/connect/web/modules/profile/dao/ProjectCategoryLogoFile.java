...
/**
 * Represents the configuration of a projectCategoryLogoFile
 *
 * @author matt rajkowski
 * @created March 6, 2009
 */
public class ProjectCategoryLogoFile extends FileItem {

  private static Log LOG = LogFactory.getLog(ProjectCategoryLogoFile.class);

  public ProjectCategoryLogoFile() {
  }


  public ProjectCategoryLogoFile(ResultSet rs) throws SQLException {
    buildRecord(rs, false);
  }

  public ProjectCategoryLogoFile(Connection db, int itemId) throws SQLException {
