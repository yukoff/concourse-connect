...
/**
 * Action for approving a listing
 *
 * @author matt rajkowski
 * @created October 7, 2009
 */
public class ApproveListingFormAction implements IPortletAction {

  private static Log LOG = LogFactory.getLog(ApproveListingFormAction.class);
  ...
  public GenericBean processAction(ActionRequest request, ActionResponse response) throws Exception {
    ...
    if (!user.getAccessAdmin()) {
      throw new PortletException("Unauthorized to approve listings");
    }
