...
/**
 * Project promotions details
 *
 * @author matt rajkowski
 * @created November 14, 2008
 */
public class PromotionsDetailsViewer implements IPortletViewer {

  // Pages
  private static final String VIEW_PAGE = "/projects_center_ads_details.jsp";
  ...
  public String doView(RenderRequest request, RenderResponse response) throws Exception {
    ...
    // @todo Check if user has access to expired records
    // @todo Check if user has access to incomplete records
    // @todo Check if user has access to not started records


    /*if (promotion.getStatus() == Ad.DRAFT && !ProjectUtils.hasAccess(project.getId(), user, "project-news-view-unreleased")) {
      throw new PortletException("Unauthorized to view this record");
    } else if (promotion.getStatus() == Ad.UNAPPROVED && !ProjectUtils.hasAccess(project.getId(), user, "project-news-view-unreleased")) {
      throw new PortletException("Unauthorized to view this record");
    }*/
