 ...
 */
public class PromotionsSetRatingViewer implements IPortletViewer {
  ...
  public String doView(RenderRequest request, RenderResponse response) throws Exception {
    ...
    RatingBean thisRating =
        Rating.save(db, user.getId(), project.getId(), promotion.getId(), vote, Ad.TABLE, Ad.PRIMARY_KEY, Constants.UNDEFINED);
