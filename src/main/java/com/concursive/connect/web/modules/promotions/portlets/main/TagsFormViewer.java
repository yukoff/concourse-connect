...
public class TagsFormViewer implements IPortletViewer {
  ...
  public String doView(RenderRequest request, RenderResponse response) throws Exception {
    ...
    if (!ModuleUtils.MODULENAME_PROMOTIONS.equals(moduleName)) {
    ...
    popularTagList.setTableName(Ad.TABLE);
    popularTagList.setUniqueField(Ad.PRIMARY_KEY);
    ...
    tagLogList.setTableName(Ad.TABLE);
    tagLogList.setUniqueField(Ad.PRIMARY_KEY);
