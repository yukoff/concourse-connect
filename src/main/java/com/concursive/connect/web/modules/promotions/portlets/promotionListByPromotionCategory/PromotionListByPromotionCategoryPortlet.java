...
/**
 * Display promotions list by promotions category list
 *
 * @author Kailash Bhoopalam
 * @created November 25, 2009
 */
public class PromotionListByPromotionCategoryPortlet extends AbstractPortletModule {

  // Logger
  private static Log LOG = LogFactory.getLog(PromotionListByPromotionCategoryPortlet.class);

  // Viewers
  public static final String DEFAULT_VIEW = "list";
  public static final String LIST_VIEW = "list";

  public PromotionListByPromotionCategoryPortlet() {
  ...
  protected void doPopulateActionsAndViewers() {
    // Viewers
    viewers.put(LIST_VIEW, new PromotionListByPromotionCategoryViewer());
  }
}