...
public class PromotionResultsCategoryCountsPortlet extends AbstractPortletModule {
  ...
  // Logger
  private static Log LOG = LogFactory.getLog(PromotionResultsCategoryCountsPortlet.class);

  // Viewers
  public static final String DEFAULT_VIEW = "list";
  public static final String LIST_VIEW = "list";

  public PromotionResultsCategoryCountsPortlet() {
    defaultCommand = DEFAULT_VIEW;
  }

  protected void doPopulateActionsAndViewers() {
    // Viewers
    viewers.put(LIST_VIEW, new PromotionResultsCategoryCountsViewer());
  }
}
