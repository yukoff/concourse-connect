...
/**
 * Sort Filter portlet for promotions
 *
 * @author Kailash Bhoopalam
 * @created November 25, 2009
 */
public class PromotionResultsSorterPortlet extends AbstractPortletModule {

  // Logger
  private static Log LOG = LogFactory.getLog(PromotionResultsSorterPortlet.class);

  // Viewers
  public static final String DEFAULT_VIEW = "list";
  public static final String LIST_VIEW = "list";

  public PromotionResultsSorterPortlet() {
    defaultCommand = DEFAULT_VIEW;
  }

  protected void doPopulateActionsAndViewers() {
    // Viewers
    viewers.put(LIST_VIEW, new PromotionResultsSorter());
  }
