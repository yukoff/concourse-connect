 ...
 */
public class SearchResultsByPromotionPortlet extends AbstractPortletModule {

  // Logger
  private static Log LOG = LogFactory.getLog(SearchResultsByPromotionPortlet.class);

  // Viewers
  public static final String DEFAULT_VIEW = "list";
  public static final String LIST_VIEW = "list";

  public SearchResultsByPromotionPortlet() {
    defaultCommand = DEFAULT_VIEW;
  }

  protected void doPopulateActionsAndViewers() {
    // Viewers
    viewers.put(LIST_VIEW, new SearchResultsByPromotion());
  }
