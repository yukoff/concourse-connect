...
/**
 * Class for calculating user contributions based on the number of reviews added
 *
...
public class ContributionCalculationForReviewsAdded extends ContributionCalculation {
