 ...
 */
public class DeleteReviewAction implements IPortletAction {
  ...
  public GenericBean processAction(ActionRequest request, ActionResponse response) throws Exception {
    ...
    // Process the review
    ProjectRating thisProjectRating = new ProjectRating(db, id);
    thisProjectRating.setModifiedBy(user.getId());
    boolean result = ProjectRating.delete(db, thisProjectRating);
    if (!result) {
      return (thisProjectRating);
    }

    // Remove from index
    indexDeleteItem(request, thisProjectRating);

    // Trigger the workflow
    processDeleteHook(request, thisProjectRating);
