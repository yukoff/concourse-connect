...
/**
 * Project reviews MVC portlet
 *
 * @author matt rajkowski
 * @created October 17, 2008
 */
public class ReviewsPortlet extends AbstractPortletModule {

  private static Log LOG = LogFactory.getLog(ReviewsPortlet.class);
  ...
  protected void doPopulateActionsAndViewers() {
    // Viewers
    viewers.put(LIST_VIEW, new ReviewsListViewer());
    viewers.put(DETAILS_VIEW, new ReviewsDetailsViewer());
