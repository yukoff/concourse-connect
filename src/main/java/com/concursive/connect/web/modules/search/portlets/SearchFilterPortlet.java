 ...
 */
package com.concursive.connect.web.modules.search.portlets;
...
public class SearchFilterPortlet extends GenericPortlet {
  ...
  // Pages
  private static final String VIEW_PAGE = "/portlets/search_filter_portlet/search_filter_portlet-view.jsp";
  // Parameters
