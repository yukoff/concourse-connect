 ...
 */
package com.concursive.connect.web.modules.setup.portlets;
...
/**
 * Project Setup mvc portlet
 *
 * @author matt rajkowski
 * @created November 7, 2008
 */
public class SetupPortlet extends AbstractPortletModule {

  private static Log LOG = LogFactory.getLog(SetupPortlet.class);
