...
/**
 * Action for unlocking a wiki entry
 *
 * @author matt rajkowski
 * @created November 3, 2008
 */
public class UnlockWikiAction implements IPortletAction {

  // Logger
  private static Log LOG = LogFactory.getLog(UnlockWikiAction.class);
