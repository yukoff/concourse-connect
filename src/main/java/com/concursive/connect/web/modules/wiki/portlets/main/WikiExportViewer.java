...
/**
 * Project wiki export options
 *
 * @author matt rajkowski
 * @created November 4, 2008
 */
public class WikiExportViewer implements IPortletViewer {

  // Logger
  private static Log LOG = LogFactory.getLog(WikiExportViewer.class);

  // Pages
  private static final String VIEW_PAGE = "/projects_center_wiki_export_options.jsp";
  ...
  // Shared variables
  public static final String QUEUE_VALUE = WikiPortlet.QUEUE_VALUE;
  public static final String QUEUE_TOTAL = WikiPortlet.QUEUE_TOTAL;
  public static final String EXPORTS_FOR_USER = WikiPortlet.EXPORTS_FOR_USER;
  ...
  public String doView(RenderRequest request, RenderResponse response) throws Exception {
    ...
    // Determine the record to start with
    ...
    // Provide the queue if needed
    WikiPortlet.populateQueueStats(request, user.getId());
