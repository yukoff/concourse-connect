...
/**
 * Project wiki versions
 *
 * @author matt rajkowski
 * @created November 3, 2008
 */
public class WikiVersionsViewer implements IPortletViewer {

  // Logger
  private static Log LOG = LogFactory.getLog(WikiVersionsViewer.class);

  // Pages
  private static final String VIEW_PAGE = "/projects_center_wiki_version_list.jsp";
  ...
  private static final String WIKI_VERSION_LIST = "versionList";
  ...
  public String doView(RenderRequest request, RenderResponse response) throws Exception {
    ...
    if (wiki.getId() > -1) {
      // Show the versions
      WikiVersionList versionList = new WikiVersionList();
      versionList.setWikiId(wiki.getId());
      versionList.buildList(db);
      request.setAttribute(WIKI_VERSION_LIST, versionList);
    }
