 ...
 */
public class ProjectWikiContentPortlet extends AbstractPortletModule {
  ...
  public ProjectWikiContentPortlet() {
    defaultCommand = DEFAULT_VIEW;
  }

  protected void doPopulateActionsAndViewers() {
    // Viewers
    viewers.put(DETAILS_VIEW, new ProjectWikiContentViewer());
  }
