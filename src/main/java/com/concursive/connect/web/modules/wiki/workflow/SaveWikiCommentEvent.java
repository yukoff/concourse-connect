...
/**
 * Records a wiki comment event
 *
 * @author matt rajkowski
 * @created August 21, 2009
 */
public class SaveWikiCommentEvent extends ObjectHookComponent implements ComponentInterface {
  ...
  public String getDescription() {
    return "Records a wiki comment event..";
  }
