 ...
 */
public class ProjectPortalBean {
  ...
  public ProjectPortalBean() {
  }

  public ProjectPortalBean(HttpServletRequest request) {
    action = request.getParameter("portlet-action");
    projectId = Integer.parseInt(request.getParameter("portlet-pid"));
  ...
  public String toString() {
    ...
    sb.append("==== ProjectPortalBean ================================").append(CRLF);
    sb.append(" action       = ").append(action).append(CRLF);
    sb.append(" projectId    = ").append(projectId).append(CRLF);
