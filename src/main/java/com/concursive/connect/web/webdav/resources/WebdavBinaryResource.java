 ...
 * @created Dec 6, 2008 7:02:22 PM
 */
public class WebdavBinaryResource extends WebdavResource {

  byte[] bytes;

  public WebdavBinaryResource(WebdavFolderResource parent, String name, byte[] bytes) {
    super(parent, name);
    this.bytes = bytes;
