ALTER TABLE project_history ADD parent_id INTEGER REFERENCES project_history(history_id);
ALTER TABLE project_history ADD top_id INTEGER REFERENCES project_history(history_id);
...
ALTER TABLE project_history ADD relative_date DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL;
ALTER TABLE project_history ADD relative_enteredby INTEGER REFERENCES users(user_id);
