INSERT INTO lookup_news_template (group_id, level, description, mapped_jsp, load_project_article_list, load_public_projects) VALUES (1, 5, 'Dashboard', 'templateDashboard.jsp', false, false);

ALTER TABLE users ADD nickname VARCHAR(255);

ALTER TABLE project_team ADD purpose INTEGER;
ALTER TABLE project_team ADD notification BOOLEAN DEFAULT false;

ALTER TABLE projects ADD badges_enabled BOOLEAN DEFAULT true NOT NULL;
...
ALTER TABLE projects ADD reviews_enabled BOOLEAN DEFAULT true NOT NULL;
...
ALTER TABLE projects ADD classifieds_enabled BOOLEAN DEFAULT true NOT NULL;
...
ALTER TABLE projects ADD ads_enabled BOOLEAN DEFAULT true NOT NULL;
