    ...
    <table width="648" border="0" cellpadding="0" cellspacing="0" style="margin:25px auto; " align="center">
      ...
      <tr>
        <td style="padding:10px 20px; background:#fff; border-right:1px solid #e2eaf8; border-left:1px solid #e2eaf8">
          <p>${user.nameFirstLastInitial?html} has sent the following private message to ${project.title?html}:</p>
      ...
      <tr>
        <td style="background:#fff;  padding:0 20px 20px;border-bottom:1px solid #e5fdfc; border-right:1px solid #e2eaf8; border-left:1px solid #e2eaf8">
          <hr/>
