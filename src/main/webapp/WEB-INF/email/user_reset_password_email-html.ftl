    ...
    <table width="648" border="0" cellpadding="0" cellspacing="0" style="margin:25px auto;" align="center">
      <tr>
        <td style="background:#fff; padding:20px 20px 0; border-top:25px solid #e3ebf8; border-right:1px solid #e2eaf8; border-left:1px solid #e2eaf8 ">
          <p>
            Hello ${firstname?html}, <br/>
            <br/>
            Your temporary password is: ${temporaryPassword}<br/>
            <br/>
            You may use this password to log into the site.<br/>
            <br/>
            After logging in, you can change your password by choosing Personal Settings from the menu options.  
          </p>
        </td>
      </tr>
      <tr>
