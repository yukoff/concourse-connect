<%--
  ...
  --%><%-- Note: Intentionally no space --%><%@ page contentType="text/xml" %>
...
<%@ include file="initPage.jsp" %><response>
  <xId><%= request.getParameter("id") %></xId>
  <id><%= task.getId() %></id>
  <notes><![CDATA[<%= toString(task.getNotes()) %> ]]></notes>
  <functionalArea><![CDATA[<%= toString(functionalAreaList.getValueFromId(task.getFunctionalArea())) %> ]]></functionalArea>
  <status><![CDATA[<%= toString(statusList.getValueFromId(task.getStatus())) %> ]]></status>
  <businessValue><![CDATA[<%= toString(businessValueList.getValueFromId(task.getBusinessValue())) %> ]]></businessValue>
  <complexity><![CDATA[<%= toString(complexityList.getValueFromId(task.getComplexity())) %> ]]></complexity>
  <targetRelease><![CDATA[<%= toString(targetReleaseList.getValueFromId(task.getTargetRelease())) %> ]]></targetRelease>
  <targetSprint><![CDATA[<%= toString(targetSprintList.getValueFromId(task.getTargetSprint())) %> ]]></targetSprint>
  <loeRemaining><![CDATA[<%= toString(loeRemainingList.getValueFromId(task.getLoeRemaining())) %> ]]></loeRemaining>
</response>
