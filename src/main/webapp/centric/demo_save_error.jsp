  ...
  <div class="portletWindowBackground">
    <div id="pagecontent">
      <div class="leftColumn">
        <h4>The activation server isn't responding at this time.</h4>
        <h4>This is most likely a temporary problem, however please contact us to report the problem, or try again later.</h4>
