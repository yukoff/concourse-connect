  ...
  <div class="portletWindowBackground">
    <div id="pagecontent">
      <div class="leftColumn">
        <h4>An account has been created for you.</h4>
        <p>
          You should receive login information and directions by email at the following address:<br>
          <strong><%= toHtml(demoBean.getEmail()) %></strong>
        </p>
        <p>
          Please check your spam and junk folder if you do not receive a confirmation within 15 minutes.
        </p>
