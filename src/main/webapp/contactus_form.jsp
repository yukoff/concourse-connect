...
<form name="contactUs" method="post" action="<%= ctx %>/ContactUs.do?command=Send&auto-populate=true" onSubmit="return checkForm(this);">
  ...
  <table cellpadding="4" cellspacing="0" width="100%" border="0">
    <tr>
      <td>
        <h1>Contact Us</h1>
        <ul>
          <li>Whether you are requesting more information,
          providing suggestions, or reporting any issues, we will gladly reply
          to the email address you provide</li>
          <li>Depending on the request, we typically respond within 24 hours</li>
        </ul>
      </td>
    </tr>
  </table>
