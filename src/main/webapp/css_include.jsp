...
<c:if test="${!empty templateColorScheme}">
  <link rel="stylesheet" href="${ctx}/themes/${templateTheme}/color-schemes/${templateColorScheme}/css/ccp-color.css" />
</c:if>
...
<pack:script>
  ...
  <src>/javascript/yui-2.7/build/menu/menu-min.js</src>
