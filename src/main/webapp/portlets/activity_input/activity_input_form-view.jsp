...
<script language="JavaScript" type="text/javascript">
  function checkActivityInputForm(form) {
    var formTest = true;
    var messageText = "";
    if (document.inputForm.body.value.trim() == "") {
...
<div class="formContainer">
  ...
  <form method="POST" name="inputForm" action="${saveFormUrl}" onSubmit="try {return checkActivityInputForm(this);}catch(e){return true;}">
    <ol>
      <li>
        <c:choose>
        ...
        <div class="portlet-section-body">
          ...
          <input id="<portlet:namespace/>body" name="body" type="text" name="body" class="input longInput" maxlength="200" value='<c:out value="${body}" />' />
