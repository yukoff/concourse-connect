...
<jsp:useBean id="blogList" class="com.concursive.connect.web.modules.blog.dao.BlogPostList" scope="request"/>
...
%>
    <li>
      <a href="${ctx}/show/<%= project.getUniqueId() %>/post/<%= blog.getId() %>">
        <%= StringUtils.toHtml(blog.getSubject()) %>
      </a>
      <span>
        <%= blog.getReadCount() %> views
      </span>
    </li>
<% } %>
</ul>
