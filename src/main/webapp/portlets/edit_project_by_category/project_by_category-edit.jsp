        ...
        <c:if test="${!empty projectBean.estimatedCloseDate}">
          <c:set var="estimatedCloseDate">
            <ccp:tz timestamp="${projectBean.estimatedCloseDate}" dateOnly="true"/>
	          ...
	          <input type="text" name="requestDate" id="requestDate" size="10" value="${requestDate}" />
		      ...
		      <fieldset>
		        ...
		        <input type="text" name="estimatedCloseDate" id="estimatedCloseDate" size="10" value="${estimatedCloseDate}" >
		    ...
		    <div class="leftColumn">
		    	...
		    	<c:if test="${!empty preferenceMap.addressLine2}">
		             <label for="<portlet:namespace/>addressline2"><c:out value="${preferenceMap.addressLine2}"/></label>
		             <input type="text" name="addressLine2" id="<portlet:namespace/>addressLine2" maxlength="80" value="<c:out value="${projectBean.addressLine2}"/>">
				  </c:if>
		    	<c:if test="${!empty preferenceMap.addressLine3}">
		             <label for="<portlet:namespace/>addressline3"><c:out value="${preferenceMap.addressLine3}"/></label>
		             <input type="text" name="addressLine3" id="<portlet:namespace/>addressLine3" maxlength="80" value="<c:out value="${projectBean.addressLine3}"/>">
				  </c:if>
            ...
            <c:if test="${!empty preferenceMap.twitterId}">
		             <label for="<portlet:namespace/>twitterId"><c:out value="${preferenceMap.twitterId}"/> (<a href="http://twitter.com" target="_blank">sign up</a>)</label>
		             <input type="text" name="twitterId" id="<portlet:namespace/>twitterId" maxlength="80" value="<c:out value="${projectBean.twitterId}"/>">
            </c:if>
            <c:if test="${!empty preferenceMap.facebookPage}">
		             <label for="<portlet:namespace/>facebookPage"><c:out value="${preferenceMap.facebookPage}"/> (<a href="http://www.facebook.com" target="_blank">sign up</a>)</label>
		             <input type="text" name="facebookPage" id="<portlet:namespace/>facebookPage" maxlength="80" value="<c:out value="${projectBean.facebookPage}"/>">
            </c:if>
            <c:if test="${!empty preferenceMap.youtubeChannelId}">
		             <label for="<portlet:namespace/>youtubeChannelId"><c:out value="${preferenceMap.youtubeChannelId}"/> (<a href="http://www.youtube.com" target="_blank">sign up</a>)</label>
		             <input type="text" name="youtubeChannelId" id="<portlet:namespace/>youtubeChannelId" maxlength="80" value="<c:out value="${projectBean.youtubeChannelId}"/>">
            </c:if>
            <c:if test="${!empty preferenceMap.ustreamId}">
		             <label for="<portlet:namespace/>ustreamId"><c:out value="${preferenceMap.ustreamId}"/> (<a href="http://www.ustream.tv" target="_blank">sign up</a>)</label>
		             <input type="text" name="ustreamId" id="<portlet:namespace/>ustreamId" maxlength="1000" value="<c:out value="${projectBean.ustreamId}"/>">
            </c:if>
            <c:if test="${!empty preferenceMap.livestreamId}">
		             <label for="<portlet:namespace/>livestreamId"><c:out value="${preferenceMap.livestreamId}"/> (<a href="http://www.livestream.com" target="_blank">sign up</a>)</label>
		             <input type="text" name="livestreamId" id="<portlet:namespace/>livestreamId" maxlength="80" value="<c:out value="${projectBean.livestreamId}"/>">
            </c:if>
            <c:if test="${!empty preferenceMap.justintvId}">
		             <label for="<portlet:namespace/>justintvId"><c:out value="${preferenceMap.justintvId}"/> (<a href="http://www.justin.tv" target="_blank">sign up</a>)</label>
		             <input type="text" name="justintvId" id="<portlet:namespace/>justintvId" maxlength="80" value="<c:out value="${projectBean.justintvId}"/>">
            </c:if>
            <c:if test="${!empty preferenceMap.qikId}">
		             <label for="<portlet:namespace/>qikId"><c:out value="${preferenceMap.qikId}"/> (<a href="http://qik.com" target="_blank">sign up</a>)</label>
		             <input type="text" name="qikId" id="<portlet:namespace/>qikId" maxlength="80" value="<c:out value="${projectBean.qikId}"/>">
            </c:if>
		    </div>
