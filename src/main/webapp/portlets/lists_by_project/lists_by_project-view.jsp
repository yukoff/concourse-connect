...
<c:choose>
  <c:when test="${!empty listItemsMap}">
    <c:forEach var='mapItem' items='${listItemsMap}' end="${limit -1}">
  ...
  <c:otherwise>
    <p><ccp:label name="project.listsitems.none">This listing has no associated lists.</ccp:label></p>
  </c:otherwise>
</c:choose>
