  ...
  <c:forEach items="${urlList}" var="url">
    ...
    <li>
      <a href="<c:if test='${!fn:contains(url["href"], "http")}'>${ctx}</c:if><c:out value='${url["href"]}'/>"
         ...
         <c:if test='${!empty url["selected"]}'>class="active"</c:if>
      ><span class="gettingStarted_tl"></span><span class="gettingStarted_tr"></span><em><c:out value='${url["content"]}'/></em><span class="gettingStarted_bl"></span><span class="gettingStarted_br"></span></a></li>
  </c:forEach>
</ul>
