...
%>
    <li>
      <a href="${ctx}/show/<%= project.getUniqueId() %>/file/<%= document.getObjectId() %>"><ccp:evaluate if="<%= StringUtils.hasText(document.getTitle()) %>"><%= StringUtils.toHtml(document.getTitle()) %></ccp:evaluate></a><br />
      <cite>
