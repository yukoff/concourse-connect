<%--
  ...
  --%>
<%@ page import="java.util.*,com.concursive.commons.text.StringUtils" %>
<%@ page import="com.concursive.connect.web.utils.LookupElement" %>
<jsp:useBean id="departments" class="com.concursive.connect.web.utils.LookupList" scope="request"/>
<html>
<head>
</head>
