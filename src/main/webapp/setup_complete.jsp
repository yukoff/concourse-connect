...
<form action="<%= RequestUtils.getAbsoluteServerUrl(request) %>/" name="setupForm" method="get" style="margin:0; width:100%; background:#efefef; ">
  <div style="width:100%; height:100%; background:#efefef; padding:15px 0 0 0; margin:0">
    <div style="width:600px; height:600px; position:relative; margin:0 auto">
      <br style="clear:both">
      <h1 style="color:#425c61; font-size:x-large; margin:35px 0">Setup is Complete!</h1>
      <div  style="font-size:small; width:500px; margin:0 auto; background:#fff; -moz-border-radius:10px; -webkit-border-radius:10px; border-color:#acacac #cacaca #d4d4d4 #aeaeae; border-width:2px; border-style:solid; padding:15px">
        <h2 style="font-size:large; font-weight:normal; text-align:center; margin:25px 0">
            ...
            You can now sign in and begin using the system.
        </h2>
      </div>
