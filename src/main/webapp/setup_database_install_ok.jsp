...
<form action="${ctx}/SetupDetails.do" name="setupForm" method="get" style="margin:0; width:100%; background:#efefef; ">
  <input type="hidden" name="command" value="ConfigureDetails" />
  <div style="width:100%; height:100%; background:#efefef; padding:15px 0 0 0; margin:0">
    <div style="width:600px; height:600px; position:relative; margin:0 auto; display:block">
      <img src="${ctx}/images/setup/step-3-header.jpg" alt="Step Three" style="margin:0 auto">
      <br style="clear:both">
