...
<form action="${ctx}/Setup.do?command=SaveLibrary&confirm=yes" name="setupForm" method="post" style="margin:0; width:100%; height:100%; background:#efefef; ">
  <input type="hidden" name="directory" value="<%= toHtmlValue(request.getParameter("directory")) %>" />
  <div style="padding:15px 0 0 0; margin:0">
    <div style="width:600px; position:relative; margin:0 auto">
      ...
      <h2 style="color:#5d9fbf; font-size:large; font-weight:normal; text-align:center">
        ...
        A file library already exists at the following location...</h2>
      <div style="font-size:small; width:500px; margin:0 auto; background:#fff; -moz-border-radius:10px; -webkit-border-radius:10px; border-color:#acacac #cacaca #d4d4d4 #aeaeae; border-width:2px; border-style:solid; padding:15px">
        ...
        <br />
        Continue and use this directory for the application?
      </div>
