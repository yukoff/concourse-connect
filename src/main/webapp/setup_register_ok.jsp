...
<form action="${ctx}/SetupDatabase.do" name="setupForm" method="get" style="margin:0; width:100%; background:#efefef; ">
  <input type="hidden" name="command" value="ConfigureDatabase" />
  <div style="width:100%; height:100%; background:#efefef; padding:15px 0 0 0; margin:0">
    <div style="width:600px; position:relative; margin:0 auto">
      ...
      <div style="font-size:small; width:500px; margin:0 auto; background:#fff; -moz-border-radius:10px; -webkit-border-radius:10px; border-color:#acacac #cacaca #d4d4d4 #aeaeae; border-width:2px; border-style:solid; padding:0 15px 15px">
        ...
        <p>
          The following account id will be recorded
          in this system's fileLibrary and is viewable in the admin module.
          A copy will be emailed to you, for future reference.
        </p>
        <h3>AccountId: <%= toHtml(applicationPrefs.get(ApplicationPrefs.CONCURSIVE_SERVICES_ID)) %></h3>
      </div>
