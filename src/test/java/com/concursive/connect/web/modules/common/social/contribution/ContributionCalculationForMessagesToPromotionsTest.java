...
import com.concursive.connect.web.modules.promotions.contribution.ContributionCalculationForMessagesToPromotions;
 ...
 */
public class ContributionCalculationForMessagesToPromotionsTest extends AbstractConnectionPoolTest {
  ...
  public void testContributionCalculationForMessagesToPromotions() throws SQLException {
    ...
    //Inserting a Ad
    Ad ad = new Ad();
    ad.setHeading("heading");
    ad.setBriefDescription1("brief description1");
    ...
    boolean adInserted = ad.insert(db);
    assertTrue("Ad was not inserted", adInserted);
    assertTrue("Ad  did not have an id", ad.getId() > -1);
    ...
    newPrivateMessage.setLinkModuleId(Constants.PROJECT_AD_FILES);
    newPrivateMessage.setLinkItemId(ad.getId());
    ...
    ContributionCalculationForMessagesToPromotions contributionCalculationForMessagesToPromotions = new ContributionCalculationForMessagesToPromotions();
    contributionCalculationForMessagesToPromotions.process(db, lookupContribution);
