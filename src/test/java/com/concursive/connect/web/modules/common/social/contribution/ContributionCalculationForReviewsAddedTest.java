...
import com.concursive.connect.web.modules.reviews.contribution.ContributionCalculationForReviewsAdded;
 ...
 */
public class ContributionCalculationForReviewsAddedTest extends AbstractConnectionPoolTest {

  protected static final int USER_ID = 1;
  //Required to insert a project
  protected static final int GROUP_ID = 1;
  
  public void testContributionCalculationForReviewsAdded() throws SQLException {

    LookupContribution lookupContribution = new LookupContribution();
    lookupContribution.setConstant("200901101230");
    lookupContribution.setDescription("Test Reviews Added Contribution");
    ...
    project.setShortDescription("Project SQL Test testContributionCalculationForReviewsAdded");
    ...
    //Inserting Project Rating
    ProjectRating newProjectRating = new ProjectRating();
    newProjectRating.setProjectId(project.getId());
    newProjectRating.setRating(3);
    ...
    ContributionCalculationForReviewsAdded contributionCalculationForReviewsAdded = new ContributionCalculationForReviewsAdded();
    contributionCalculationForReviewsAdded.process(db, lookupContribution);
