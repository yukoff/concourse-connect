 ...
 * @created Feb 22, 2009
 */
public class SaveDocumentDeleteEventTest extends AbstractWorkflowManagerTest {
  protected static final int GROUP_ID = 1;
  protected static final String PROCESS_NAME = "teamelements.application.project.delete-document";
  protected final static String HISTORY_TEXT = "history.text";

  public void testSaveDocumentDeleteEvent() throws Exception {
    // Insert project
    ...
    historyList.setLinkObject(ProjectHistoryList.DOCUMENT_DELETE_OBJECT);
    historyList.setEventType(ProjectHistoryList.DELETE_PROFILE_DOCUMENT_EVENT);
    ...
    assertEquals("Recorded event mismatch",
        "[[|" + userProfile.getId() + ":profile||" + userProfile.getTitle() + "]] deleted [[|" + project.getId() + ":file|" + thisFile.getId() + "|Dummy Subject]]",
