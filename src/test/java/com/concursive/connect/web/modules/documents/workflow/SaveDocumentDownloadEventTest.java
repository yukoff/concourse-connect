 ...
 * @created Feb 22, 2009
 */
public class SaveDocumentDownloadEventTest extends AbstractWorkflowManagerTest {
  protected static final int GROUP_ID = 1;
  protected static final String PROCESS_NAME = "teamelements.application.project.download-document";
  ...
  public void testSaveDocumentDownloadEvent() throws Exception {
    ...
    assertEquals("Recorded event mismatch",
        "[[|" + userProfile.getId() + ":profile||" + userProfile.getTitle() + "]] downloaded [[|" + project.getId() + ":file|" + thisFile.getId() + "|Dummy Subject]]",
