...
/**
 * Tests to see if events are being recorded when a new project is added.
 *
 * @author Ananth
 * @created Feb 12, 2009
 */
public class SaveProjectAddEventTest extends AbstractWorkflowManagerTest {
  protected static final int GROUP_ID = 1;
  protected static final String PROCESS_NAME = "teamelements.application.project.insert";
