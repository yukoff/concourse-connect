...
/**
 * Test to see if events are being recorded when a user shares project images..
 *
 * @author Ananth
 * @created Feb 22, 2009
 */
public class SaveProjectShareImageEventTest extends AbstractWorkflowManagerTest {
  protected static final int GROUP_ID = 1;
  protected static final String PROCESS_NAME = "teamelements.application.project.share-image";
  ...
  public void testSaveProjectShareImageEvent() throws Exception {
    ...
    assertEquals("Recorded event mismatch", 
        "[[|" + userProfile.getId() + ":profile||" + userProfile.getTitle() + "]] shared an image with [[|" + project.getId() + ":profile||Project SQL Test]]",
