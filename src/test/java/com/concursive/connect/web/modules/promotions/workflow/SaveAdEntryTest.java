...
/**
 * Test to see if a ad entry is being recorded...
 *
 * @author Ananth
 * @created Feb 22, 2009
 */
public class SaveAdEntryTest extends AbstractWorkflowManagerTest {
  protected static final int GROUP_ID = 1;
  protected static final String PROCESS_NAME = "teamelements.application.project.add-promotion";
