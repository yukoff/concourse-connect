...
public class SaveWikiEventTest extends AbstractWorkflowManagerTest {
  ...
  public void testSaveWikiEvent() throws Exception {
    ...
    assertEquals("Recorded event mismatch",
        "[[|" + userProfile.getId() + ":profile||" + userProfile.getTitle() + "]] contributed to [[|" + project.getId() + ":wiki|Dummy Wiki Subject|Dummy Wiki Subject]] in [[|" + project.getId() + ":profile||Project SQL Test]]",
