 ...
 */
public class LookupListAPITest extends AbstractAPITest {

  public void testSelectLookupProjectRoleList() throws Exception {
    ...
    assertTrue("No records found in list", api.getRecordCount() > 0);
